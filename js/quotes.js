const quotes = [
    ...
    const author2 = document.querySelector("#quote span:last-child");
    
   const  today_Quote= quotes[Math.floor(Math.random() * quotes.length)];
   quote2.innerText = today_Quote.quote;
   author2.innerText = today_Quote.author;
    // function setQuote() {
    // const randomQuote = quotes[Math.floor(Math.random() * quotes.length)];
    // quote2.innerText = randomQuote.quote;
    // author2.innerText = randomQuote.author;
    // }
